// export LD_LIBRARY_PATH=/xubinbin/librtmp/install/lib:$LD_LIBRARY_PATH
...
char* rtmpurl="rtmp://transcode.area.live.00cdn.com:2955/live_panda?vhost=ps8.live.panda.tv/th_test_src_starem?need_gop_ts=0&add_index_info=0";//连接的URL
char* flvfilename="/mtfs/media/92d768563027d708b0cb81793d93b3bf-1527777710159.flv";//读取的flv文件
...
//	RTMP_LogSetOutput(FILE*fp);//设置信息输出文件
	...
	RTMPPacket_Alloc(packet,1024*1000);//给packet分配数据空间
